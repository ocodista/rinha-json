...
function cs(e, t, n) {
  ...
  if (t != null)
    ...
    t))
      as.call(t, r) && !fs.hasOwnProperty(r) && (l[r] = t[r]);
...
P.StrictMode = Tf;
P.Suspense = Nf;
P.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED = Of;
...
P.isValidElement = Zi;
P.lazy = function (e) {
  return { $$typeof: If, _payload: { _status: -1, _result: e }, _init: Pf };
};
P.memo = function (e, t) {
 ...
 */ var Mf = Me,
  ...
  Ff = Mf.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.ReactCurrentOwner,
...
function ds(e, t, n) {
  ...
  for (r in t) Df.call(t, r) && !Bf.hasOwnProperty(r) && (l[r] = t[r]);
  if (e && e.defaultProps)
 ...
 */ (function (e) {
  ...
  function A(N, C) {
    ...
    try {
      for (
        d(C), h = n(s);
        h !== null && (!(h.expirationTime > C) || (N && !Pe()));
...
function rn(e, t) {
  for (Bn[e] = t, e = 0; e < t.length; e++) vs.add(t[e]);
}
var Xe = !(
    typeof window > "u" ||
...
var et = Es.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED,
...
function Jf(e, t, n, r, l, i, u, o, s) {
  (Cn = !1), (Br = null), Zf.apply(Xf, arguments);
}
function qf(e, t, n, r, l, i, u, o, s) {
  if ((Jf.apply(this, arguments), Cn)) {
    if (Cn) {
      var f = Br;
      (Cn = !1), (Br = null);
...
function Us(e) {
  return (e = bf(e)), e !== null ? Ds(e) : null;
}
function Ds(e) {
...
var Fs = Le.unstable_scheduleCallback,
  eo = Le.unstable_cancelCallback,
  ec = Le.unstable_shouldYield,
  tc = Le.unstable_requestPaint,
  Z = Le.unstable_now,
  nc = Le.unstable_getCurrentPriorityLevel,
  ru = Le.unstable_ImmediatePriority,
  Bs = Le.unstable_UserBlockingPriority,
  Gr = Le.unstable_NormalPriority,
  rc = Le.unstable_LowPriority,
  zs = Le.unstable_IdlePriority,
  sl = null,
  Ve = null;
function lc(e) {
...
var Fe = Math.clz32 ? Math.clz32 : oc,
  ic = Math.log,
  uc = Math.LN2;
function oc(e) {
  return (e >>>= 0), e === 0 ? 32 : (31 - ((ic(e) / uc) | 0)) | 0;
}
var dr = 64,
  pr = 4194304;
function Rn(e) {
...
function yn(e, t) {
  e.blockedOn === t &&
    ...
    Ei ||
      ((Ei = !0),
      Le.unstable_scheduleCallback(Le.unstable_NormalPriority, pc)));
}
function Vn(e) {
  function t(l) {
    return yn(l, e);
...
function uu(e, t, n, r) {
  if (Hr) {
    var l = vi(e, t, n, r);
    if (l === null) jl(e, t, r, Vr, n), to(e, r);
    else if (dc(l, e, t, n, r)) r.stopPropagation();
    else if ((to(e, r), t & 4 && -1 < cc.indexOf(e))) {
      for (; l !== null; ) {
        var i = lr(l);
        if (
          (i !== null && Hs(i),
...
var dn = {
  ...
  lo = Ae(al),
  vc = Q({}, al, { dataTransfer: 0 }),
  _c = Ae(vc),
  yc = Q({}, rr, { relatedTarget: 0 }),
  xl = Ae(yc),
  Tc = Q({}, dn, { animationName: 0, elapsedTime: 0, pseudoElement: 0 }),
  gc = Ae(Tc),
  Lc = Q({}, dn, {
...
var Cc = Q({}, rr, {
  ...
  Mc = Ae(Oc),
  xc = Q({}, dn, { propertyName: 0, elapsedTime: 0, pseudoElement: 0 }),
  Uc = Ae(xc),
  Dc = Q({}, al, {
    deltaX: function (e) {
...
var zc = Xe && "TextEvent" in window && !kn,
  Zs = Xe && (!fu || (kn && 8 < kn && 11 >= kn)),
...
function jc(e, t) {
  if (Gt)
    return e === "compositionend" || (!fu && Xs(e, t))
      ? ((e = Ys()), (wr = ou = ut = null), (Gt = !1), e)
      : null;
  switch (e) {
    case "paste":
      return null;
...
if (Xe) {
  ...
  if (Xe) {
    ...
    if (!Dl) {
      ...
      fo.setAttribute("oninput", "return;"),
        (Dl = typeof fo.oninput == "function");
    }
    Ul = Dl;
  } else Ul = !1;
  bs = Ul && (!document.documentMode || 9 < document.documentMode);
}
function co() {
  Pn && (Pn.detachEvent("onpropertychange", ea), ($n = Pn = null));
}
function ea(e) {
  if (e.propertyName === "value" && fl($n)) {
    var t = [];
    qs(t, $n, e, nu(e)), Ms(Vc, t);
  }
}
function Qc(e, t, n) {
  e === "focusin"
    ? (co(), (Pn = t), ($n = n), Pn.attachEvent("onpropertychange", ea))
    : e === "focusout" && co();
}
function Wc(e) {
...
var ze = typeof Object.is == "function" ? Object.is : Zc;
function Qn(e, t) {
  if (ze(e, t)) return !0;
...
var Jc = Xe && "documentMode" in document && 11 >= document.documentMode,
  jt = null,
  _i = null,
  On = null,
  yi = !1;
...
function cl(e) {
  ...
  var t = Ht[e],
    n;
  for (n in t) if (t.hasOwnProperty(n) && n in ra) return (Fl[e] = t[n]);
  return e;
}
var la = cl("animationend"),
  ia = cl("animationiteration"),
  ua = cl("animationstart"),
  oa = cl("transitionend"),
  sa = new Map(),
  Eo =
...
for (var Bl = 0; Bl < Eo.length; Bl++) {
  var zl = Eo[Bl],
    qc = zl.toLowerCase(),
    bc = zl[0].toUpperCase() + zl.slice(1);
  _t(qc, "on" + bc);
}
_t(la, "onAnimationEnd");
_t(ia, "onAnimationIteration");
_t(ua, "onAnimationStart");
_t("dblclick", "onDoubleClick");
_t("focusin", "onFocus");
_t("focusout", "onBlur");
_t(oa, "onTransitionEnd");
...
var In =
  ...
  ed = new Set("cancel close invalid load scroll toggle".split(" ").concat(In));
function vo(e, t, n) {
  ...
  Ms(function () {
    ...
    if (!(t & 7)) {
      ...
      if (fu)
        ...
        Gt
          ? Xs(e, n) && (w = "onCompositionEnd")
          : e === "keydown" && n.keyCode === 229 && (w = "onCompositionStart");
      w &&
        (Zs &&
          n.locale !== "ko" &&
          (Gt || w !== "onCompositionStart"
            ? w === "onCompositionEnd" && Gt && (I = Ys())
            : ((ut = m),
              (ou = "value" in ut ? ut.value : ut.textContent),
              (Gt = !0))),
        (R = $r(f, w)),
        0 < R.length &&
          ((w = new io(w, e, null, n, m)),
          h.push({ event: w, listeners: R }),
          I ? (w.data = I) : ((I = Js(n)), I !== null && (w.data = I)))),
        (I = zc ? Gc(e, n) : jc(e, n)) &&
          ((f = $r(f, "onBeforeInput")),
          0 < f.length &&
            ((m = new io("onBeforeInput", "beforeinput", null, n, m)),
...
function _r(e, t, n) {
  if (((t = yo(t)), yo(e) !== t && n)) throw Error(v(425));
}
function Qr() {}
var Ti = null,
  gi = null;
...
var Si = typeof setTimeout == "function" ? setTimeout : void 0,
  ...
  ld =
    typeof queueMicrotask == "function"
      ...
      : typeof To < "u"
      ? function (e) {
          return To.resolve(null).then(e).catch(id);
        }
      : Si;
function id(e) {
  setTimeout(function () {
...
function ca(e, t, n) {
  ...
  if (((t = t.childContextTypes), typeof r.getChildContext != "function"))
    return n;
  r = r.getChildContext();
  for (var l in r) if (!(l in t)) throw Error(v(108, Qf(e) || "Unknown", l));
  return Q({}, n, r);
}
function Kr(e) {
  return (
...
function Tt() {
  if (!Vl && We !== null) {
    ...
    try {
      ...
      throw (We !== null && (We = We.slice(e + 1)), Fs(ru, Tt), l);
    } finally {
      (U = t), (Vl = !1);
    }
  }
...
function pa(e, t, n) {
  (Ne[Re++] = Ke), (Ne[Re++] = Ye), (Ne[Re++] = Pt), (Pt = e);
  var r = Ke;
  e = Ye;
  var l = 32 - Fe(r) - 1;
  (r &= ~(1 << l)), (n += 1);
      ...
      return (
        (t =
          t.nodeType !== 1 || n.toLowerCase() !== t.nodeName.toLowerCase()
            ...
            : t),
        t !== null
          ? ((e.stateNode = t), (ge = e), (Te = ct(t.firstChild)), !0)
          : !1
      );
    case 6:
      return (
        (t = e.pendingProps === "" || t.nodeType !== 3 ? null : t),
        t !== null ? ((e.stateNode = t), (ge = e), (Te = null), !0) : !1
      );
    case 13:
      return (
  ...
  if (H) {
    ...
    if (t) {
      ...
      if (!Ao(e, t)) {
        ...
        t && Ao(e, t)
          ? ha(r, n)
          : ((e.flags = (e.flags & -4097) | 2), (H = !1), (ge = e));
      }
    } else {
      if (Ri(e)) throw Error(v(418));
      (e.flags = (e.flags & -4097) | 2), (H = !1), (ge = e);
...
function yr(e) {
  ...
  } else Te = ge ? ct(e.stateNode.nextSibling) : null;
  return !0;
}
function ma() {
...
function ki(e, t, n, r) {
  var l = e.stateNode;
  (l.props = n), (l.state = e.memoizedState), (l.refs = _a), yu(e);
  var i = t.contextType;
  typeof i == "object" && i !== null
    ? (l.context = Ce(i))
...
function Ta(e) {
  ...
  function g(c, a, d, E) {
    ...
    if (w === d.length) return n(c, I), H && St(c, w), A;
    if (I === null) {
      for (; w < d.length; w++)
        (I = h(c, d[w], E)),
          I !== null &&
  ...
  function L(c, a, d, E) {
    ...
    for (
      ...
      I.index > w ? ((K = I), (I = null)) : (K = I.sibling);
      var Pe = p(c, I, O.value, E);
      if (Pe === null) {
        I === null && (I = K);
        break;
      }
      e && I && Pe.alternate === null && t(c, I),
        (a = i(Pe, a, w)),
        R === null ? (A = Pe) : (R.sibling = Pe),
        (R = Pe),
        (I = K);
    }
    if (O.done) return n(c, I), H && St(c, w), A;
    if (I === null) {
    ...
    if (
      ...
      switch (d.$$typeof) {
        ...
        case Bt:
          ...
          return u(c);
        case nt:
          return (R = d._init), F(c, a, R(d._payload), E);
      }
...
function Tu(e, t) {
  switch ((z(Xn, t), z(Zn, e), z($e, ir), (e = t.nodeType), e)) {
    case 9:
    case 11:
...
function Au(e, t, n, r, l, i) {
  if (
    ...
    (t.updateQueue = null),
    (t.lanes = 0),
    (Pr.current = e === null || e.memoizedState === null ? hd : md),
    (e = n(r, l)),
    Mn)
  ) {
    i = 0;
...
function Aa(e, t) {
  ...
  if (
    ...
    (r = r.queue),
    Ru(Ia.bind(null, n, r, e), [e]),
    r.getSnapshot !== t || i || (ee !== null && ee.memoizedState.tag & 1))
  ) {
    if (
      ((n.flags |= 2048),
      bn(9, Ra.bind(null, n, r, l, t), void 0, null),
      te === null)
    )
      throw Error(v(349));
    Ot & 30 || Na(n, t, l);
...
function Ra(e, t, n, r) {
  (t.value = n), (t.getSnapshot = r), wa(t) && Ca(e);
}
function Ia(e, t, n) {
  return n(function () {
    wa(t) && Ca(e);
...
function xa(e, t, n) {
  return (
    (n = n != null ? n.concat([e]) : null), ml(4, 4, Ma.bind(null, t, e), n)
  );
}
function Iu() {}
function Ua(e, t) {
...
function Fa(e, t, n) {
  return Ot & 21
    ? (ze(n, t) || ((n = Gs()), ($.lanes |= n), (Mt |= n), (e.baseState = !0)),
      t)
...
function pd(e, t, n) {
  ...
  if (za(e)) Ga(t, l);
    ...
    (n = Ea(e, t, l, r)),
      n !== null && ((l = ce()), Be(n, e, r, l), ja(n, t, r));
  }
}
function za(e) {
  var t = e.alternate;
...
var tl = {
  ...
  hd = {
    ...
    useImperativeHandle: function (e, t, n) {
      return (
        ...
        Or(4194308, 4, Ma.bind(null, t, e), n)
      );
    },
    ...
    useTransition: function () {
      var e = Po(!1),
        t = e[0];
      return (e = cd.bind(null, e[1])), (je().memoizedState = e), [t, e];
    },
    ...
    useSyncExternalStore: function (e, t, n) {
      ...
      return (
        (l.queue = i),
        Oo(Ia.bind(null, r, i, e), [e]),
        (r.flags |= 2048),
        bn(9, Ra.bind(null, r, i, n, t), void 0, null),
        n
      );
    },
    useId: function () {
  ...
  Ed = {
    ...
    useDeferredValue: function (e) {
      var t = ke();
      return J === null ? (t.memoizedState = e) : Fa(t, J.memoizedState, e);
    },
    useTransition: function () {
      var e = Kl(qn)[0],
        t = ke().memoizedState;
  ...
  return (
    ...
    e !== null && !me
      ? ((t.updateQueue = e.updateQueue),
        ...
        (e.lanes &= ~l),
        be(e, t, l))
      : (H && n && du(t), (t.flags |= 1), fe(e, t, r, l), t.child)
  );
}
  ...
  return (
    ...
    e !== null && !me
      ? ((t.updateQueue = e.updateQueue),
        ...
        (e.lanes &= ~l),
        be(e, t, l))
      : (H && r && du(t), (t.flags |= 1), fe(e, t, n, l), t.child)
  );
}
function Bo(e, t, n, r, l) {
  ...
  if ((tn(t, l), t.stateNode === null))
    Mr(e, t), ya(t, n, r), ki(t, n, r, l), (r = !0);
  else if (e === null) {
    var u = t.stateNode,
      o = t.memoizedProps;
    u.props = o;
...
function Mi(e, t, n, r, l, i) {
  Wa(e, t);
  var u = (t.flags & 128) !== 0;
  if (!r && !u) return l && So(t, n, !1), be(e, t, i);
...
function gd(e, t, n) {
  ...
  switch ((pu(t), t.tag)) {
      ...
      if (((n = t.type), e !== null && t.stateNode != null))
        ...
        if (((e = It($e.current)), yr(t))) {
          ...
          switch (((r[He] = t), (r[Yn] = i), (e = (t.mode & 1) !== 0), n)) {
            ...
            case "video":
            case "audio":
              for (l = 0; l < In.length; l++) G(In[l], r);
              break;
            case "source":
              G("error", r);
              break;
          ...
          e: {
            switch (((u = fi(n, r)), n)) {
              ...
              case "video":
              case "audio":
                for (l = 0; l < In.length; l++) G(In[l], e);
                l = r;
                break;
              case "source":
                G("error", e), (l = r);
    ...
    case 17:
      return ve(t.type) && Wr(), ue(t), null;
    case 19:
      if ((j(V), (i = t.memoizedState), i === null)) return ue(t), null;
        ...
        if (!r)
          if (((e = br(u)), e !== null)) {
            if (
              ...
              Ln(i, !0),
              i.tail === null && i.tailMode === "hidden" && !u.alternate && !H)
            )
              return ue(t), null;
          } else
    ...
    case 23:
      return (
        ...
        r && t.mode & 1
          ? ye & 1073741824 && (ue(t), t.subtreeFlags & 6 && (t.flags |= 8192))
          : ue(t),
        null
      );
    case 24:
...
function ba(e) {
  ...
  t !== null && ((e.alternate = null), ba(t)),
    ...
    e.tag === 5 &&
      ((t = e.stateNode),
      t !== null &&
        (delete t[He], delete t[Yn], delete t[Ai], delete t[ud], delete t[od])),
    (e.stateNode = null),
    (e.return = null),
    (e.dependencies = null),
...
function nf(e, t) {
  ...
  switch (e.tag) {
    ...
    case 15:
      ...
      break;
    case 1:
      Oe(t, e), Ge(e), r & 512 && n !== null && Yt(n, n.return);
      break;
    case 5:
      if (
        (Oe(t, e),
      ...
      if (r & 4 && ((l = e.stateNode), l != null)) {
        ...
        if (((e.updateQueue = null), s !== null))
          try {
            o === "input" && i.type === "radio" && i.name != null && Ss(l, i),
              fi(o, u);
            var f = fi(o, i);
    ...
    case 3:
      if (
        (Oe(t, e), Ge(e), r & 4 && n !== null && n.memoizedState.isDehydrated)
      )
        try {
          Vn(t.containerInfo);
        } catch (L) {
    ...
    case 22:
      if (
        ...
        e.mode & 1 ? ((oe = (f = oe) || m), Oe(t, e), (oe = f)) : Oe(t, e),
        Ge(e),
        r & 8192)
      ) {
        if (
          ...
          for (S = l; S !== null; )
            (u = S),
              ...
              u.tag === 22 && u.memoizedState !== null
                ...
                ? ((s.return = u), (S = s))
                : Wo(l);
        for (; i !== null; ) (S = i), rf(i), (i = i.sibling);
        (S = l), (Lr = o), (oe = f);
      }
      $o(e);
    } else
...
function _e(e, t) {
  ...
  if (r === 0)
    ...
    if ((n != null && eo(n), t === 1))
      e.tag === 0 ? sd(Ko.bind(null, e)) : da(Ko.bind(null, e)),
        ld(function () {
          !(M & 6) && Tt();
        }),
        (n = null);
...
function lf(e, t) {
  ...
  return _e(e, Z()), e.callbackNode === n ? lf.bind(null, e) : null;
}
function Vi(e, t) {
  var n = Un;
  return (
...
function xt(e) {
  ...
  try {
    ...
    (U = r), (we.transition = n), (M = t), !(M & 6) && Tt();
  }
}
function Mu() {
  (ye = Zt.current), j(Zt);
...
function At(e, t, n) {
  var r = U,
    l = we.transition;
  try {
    (we.transition = null), (U = 1), kd(e, t, n, r);
  } finally {
    (we.transition = l), (U = r);
  }
  return null;
...
function nn() {
  if (ot !== null) {
    var e = js(ll),
      ...
      n = U;
    try {
      if (((we.transition = null), (U = 16 > e ? 16 : e), ot === null))
        var r = !1;
      else {
...
cf = function (e, t, n) {
  if (e !== null)
    if (e.memoizedProps !== t.pendingProps || Ee.current) me = !0;
      ...
      if (!(e.lanes & n) && !(t.flags & 128)) return (me = !1), Td(e, t, n);
      me = !!(e.flags & 131072);
    }
  else (me = !1), H && t.flags & 1048576 && pa(t, Zr, t.index);
  switch (((t.lanes = 0), t.tag)) {
      ...
      return (
        ...
        l.$$typeof === void 0
          ? ((t.tag = 1),
            ...
            ki(t, r, e, n),
            (t = Mi(null, t, r, !0, i, n)))
          : ((t.tag = 0), H && i && du(t), fe(null, t, l, n), (t = t.child)),
        t
      );
    case 16:
      r = t.elementType;
    ...
    case 3:
      e: {
        if ((Ka(t), e === null)) throw Error(v(387));
        (r = t.pendingProps),
          (i = t.memoizedState),
          (l = i.element),
          va(e, t),
        ...
        if (((r = u.element), i.isDehydrated))
          if (
            ...
            (l = an(Error(v(423)), t)), (t = zo(e, t, r, n, l));
            break e;
          } else if (r !== l) {
            (l = an(Error(v(424)), t)), (t = zo(e, t, r, n, l));
            break e;
          } else
            for (
...
function Dr(e, t, n, r, l, i) {
  ...
  if (((r = e), typeof e == "function")) Uu(e) && (u = 1);
    ...
    e: switch (e) {
      ...
      case ei:
        return (
          (e = Ie(12, n, t, l | 2)), (e.elementType = ei), (e.lanes = i), e
        );
      case ti:
        return (e = Ie(13, n, t, l)), (e.elementType = ti), (e.lanes = i), e;
      case ni:
        return (e = Ie(19, n, t, l)), (e.elementType = ni), (e.lanes = i), e;
      case Ts:
        return _l(n, l, i, t);
      default:
        if (typeof e == "object" && e !== null)
  ...
  return (
    (t = Ie(u, n, t, l)), (t.elementType = e), (t.type = r), (t.lanes = i), t
  );
}
function Ct(e, t, n, r) {
...
function zd(e, t, n, r, l) {
  ...
  var s = Du(e, 0, !1, null, null, !1, !1, "", Xo);
  return (
...
Ps = Ou;
Os = xt;
var Gd = { usingClientEntryPoint: !1, Events: [lr, Vt, dl, Cs, ks, Ou] },
  Sn = {
  ...
  jd = {
    ...
    findFiberByHostInstance: Sn.findFiberByHostInstance || Bd,
...
Se.hydrateRoot = function (e, t, n) {
  ...
  if (
    ...
    (t = hf(t, null, e, 1, n ?? null, l, !1, i, u)),
    (e[Je] = t.current),
    Wn(e),
    r)
  )
...
var Hd = ps.exports,
  Jo = Hd;
(ql.createRoot = Jo.createRoot), (ql.hydrateRoot = Jo.hydrateRoot);
const Vd = ({ onValidJsonLoad: e }) => {
  ...
  return D.jsxs("main", {
    ...
    children: [
      D.jsx("h1", {
        className: "text-black text-center font-bold text-4xl leading-none",
      ...
      t && D.jsx("span", { id: "error-message", children: t }),
    ],
  });
};
var _;
...
const Qd = { stringBufferSize: 0, numberBufferSize: 0, separator: void 0 };
...
class Wd {
  constructor(t) {
    (this.state = T.START),
      ...
      (this.offset = -1),
      (t = Object.assign(Object.assign({}, Qd), t)),
      (this.bufferedString =
        t.stringBufferSize && t.stringBufferSize > 4
          ? new bo(t.stringBufferSize)
          : new qo()),
      (this.bufferedNumber =
        t.numberBufferSize && t.numberBufferSize > 0
          ? new bo(t.numberBufferSize)
          : new qo()),
      ...
      for (let r = 0; r < n.length; r += 1) {
        ...
        throw new Fn(
          `Unexpected "${String.fromCharCode(
            l,
          )}" at position "${r}" in state ${es(this.state)}`,
        );
      }
    } catch (n) {
      this.error(n);
  ...
  error(t) {
    ...
    switch (this.state) {
      ...
      default:
        this.error(
          new Fn(
            `Tokenizer ended in the middle of a token (state: ${es(
              this.state,
...
const Kd = { paths: void 0, keepStack: !0, separator: void 0 };
...
class Yd {
  constructor(t) {
    (this.state = B.VALUE),
      ...
      (this.value = void 0),
      (this.stack = []),
      (t = Object.assign(Object.assign({}, Kd), t)),
      t.paths &&
  ...
  pop() {
    ...
    ({
      ...
      (this.state = this.mode !== void 0 ? B.COMMA : B.VALUE),
      this.emit(t, n);
  }
  emit(t, n) {
    !this.keepStack &&
      ...
      this.stack.length === 0 &&
        (this.separator
          ? (this.state = B.SEPARATOR)
          : this.separator === void 0 && this.end());
  }
  get isEnded() {
    return this.state === B.ENDED;
  }
  write({ token: t, value: n }) {
    try {
      if (this.state === B.VALUE) {
        if (
          t === x.STRING ||
          t === x.NUMBER ||
          t === x.TRUE ||
          ...
          this.mode === ae.OBJECT
            ? ((this.value[this.key] = n), (this.state = B.COMMA))
            : this.mode === ae.ARRAY &&
              (this.value.push(n), (this.state = B.COMMA)),
        ...
        if (t === x.LEFT_BRACE) {
          ...
          (this.mode = ae.OBJECT), (this.state = B.KEY), (this.key = void 0);
          return;
        }
        if (t === x.LEFT_BRACKET) {
          if ((this.push(), this.mode === ae.OBJECT))
          ...
          (this.mode = ae.ARRAY), (this.state = B.VALUE), (this.key = 0);
          return;
        }
        if (
          this.mode === ae.ARRAY &&
      ...
      if (this.state === B.COLON && t === x.COLON) {
        this.state = B.VALUE;
        return;
      }
      if (this.state === B.COMMA) {
        if (t === x.COMMA) {
          if (this.mode === ae.ARRAY) {
            (this.state = B.VALUE), (this.key += 1);
            return;
          }
      ...
      throw new Xt(
        `Unexpected ${x[t]} (${JSON.stringify(n)}) in state ${ts(this.state)}`,
      );
    } catch (r) {
      this.error(r);
    }
  ...
  error(t) {
    this.state !== B.ENDED && (this.state = B.ERROR), this.onError(t);
  }
  end() {
    (this.state !== B.VALUE && this.state !== B.SEPARATOR) ||
    this.stack.length > 0
      ? this.error(
          new Error(
            `Parser ended in mid-parsing (state: ${ts(
              this.state,
            )}). Either not all the data was received or the data was invalid.`,
          ),
        )
      : ((this.state = B.ENDED), this.onEnd());
  }
  onValue(t) {
    throw new Xt(
...
class Zd {
  constructor(t = {}) {
    (this.tokenizer = new Wd(t)),
      (this.tokenParser = new Yd(t)),
...
const Xd = ({ arr: e = [] }) => {
    ...
    return D.jsxs(D.Fragment, {
      children: [
        D.jsx("span", { "aria-label": "array-start", children: "[" }),
        t.map((n) => {
          const r = e[n];
          return D.jsxs(
            "div",
            {
              "aria-label": "inside-array",
              children: [
                D.jsx("span", {
                  "aria-label": "array-prop-index",
                  children: `${n}: `,
                }),
                D.jsx(Gu, { json: r }),
              ],
        ...
        D.jsx("span", { "aria-label": "array-end", children: "]" }),
      ],
    });
  },
  Jd = ({ json: e }) =>
    e === null ? "" : typeof e == "string" ? `"${e}"` : e.toString(),
  qd = ({ json: e }) =>
    Object.keys(e).map((n) => {
      const r = e[n];
      return D.jsxs(
        ...
        {
          children: [
            D.jsx("span", { "aria-label": n, children: `${n}: ` }),
            D.jsx(Gu, { json: r }),
          ],
        },
        n,
  ...
  bd = ({ name: e, ...t }) =>
    D.jsxs("section", {
      className: "w-[44%] p-3",
      children: [
        D.jsx("h1", { className: "text-2xl font-bold", children: e }),
        D.jsx(Gu, { ...t }),
      ],
    }),
  ns = 500;
function ep() {
  const [e, t] = Me.useState({ name: "" }),
    [{ jsonParser: n, worker: r }, l] = Me.useState({
      jsonParser: void 0,
      worker: void 0,
    }),
    [i, u] = Me.useState(!1),
    [o, s] = Me.useState(void 0),
    [f, m] = Me.useState(0),
    h = (y) => {
      if ((t(y), !r)) throw new Error("Worker hasn't loaded yet...");
      r == null || r.postMessage({ file: y, chunkSize: ns, currentPage: 0 });
    };
  Me.useEffect(() => {
    const y = new Zd();
    return (
      (y.onValue = (g) => {
        const { value: L, key: F, stack: c } = g;
        s(F ? c : L);
      }),
      l({ jsonParser: y, worker: new Worker("./worker.js") }),
      () => (r == null ? void 0 : r.terminate())
    );
  }, []),
    Me.useEffect(() => {
      r &&
        (r.onmessage = ({ data: { chunkText: y } }) => {
          if (!y) {
            u(!1);
            return;
          }
          n == null || n.write(y), f < 5 && m(f + 1);
        });
    }, [n, f, r]),
    Me.useEffect(() => {
      f &&
        (r == null ||
          r.postMessage({ file: e, chunkSize: ns, currentPage: f }));
    }, [f, e, r]);
  const p = !o && !i;
  return D.jsxs("main", {
    ...
    children: [
      o && D.jsx(bd, { name: e.name, json: o }),
      p && D.jsx(Vd, { onValidJsonLoad: h }),
      i && D.jsx("span", { children: "Loading..." }),
    ],
  });
}
ql.createRoot(document.getElementById("root")).render(D.jsx(ep, {}));
